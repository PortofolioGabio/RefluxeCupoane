  ...
  const plans = [
    {
      ...
      features: [
        ...
        { text: "Link pentru Recenzii Google", enabled: false },
        { text: "Program Happy-Hour", enabled: false },
        { text: "Formular personalizat", enabled: false },
        { text: "Program de recomandări", enabled: false },
        { text: "4 Mesaje Automatizate", enabled: false },
        { text: "Asistent de cont personal", enabled: false },
        { text: "Acces manager personalizat", enabled: false },
        { text: "Notificări personalizate", enabled: false },
        { text: "Automatizări avansate", enabled: false },
        { text: "Integrare prin API", enabled: false },
    ...
    },
    {
      ...
      features: [
        { text: "3 oferte active", enabled: true },
        { text: "3 conturi scanner", enabled: true },
        { text: "∞ Bază de clienți", enabled: true },
        { text: "∞ Notificări PUSH", enabled: true },
        { text: "∞ Campanii speciale", enabled: true },
        { text: "Mesaj automat la 100m", enabled: true },
        { text: "Media bonului și orele de activitate", enabled: true },
        { text: "Află cine revine și cât de des", enabled: true },
        { text: "Link pentru Recenzii Google", enabled: true },
        { text: "Program Happy-Hour", enabled: true },
        { text: "Formular personalizat", enabled: true },
        { text: "Program de recomandări", enabled: true },
        { text: "4 Mesaje Automatizate", enabled: true },
        { text: "Asistent de cont personal", enabled: false },
        { text: "Acces manager personalizat", enabled: false },
        { text: "Notificări personalizate", enabled: false },
        { text: "Automatizări avansate", enabled: false },
    ...
    },
    {
      ...
      features: [     
        { text: "10 oferte active", enabled: true },
        { text: "10 conturi scanner", enabled: true },
        { text: "∞ Bază de clienți", enabled: true },
        { text: "∞ Notificări PUSH", enabled: true },
        { text: "∞ Campanii speciale", enabled: true },
        { text: "Mesaj automat la 100m", enabled: true },
        ...
        { text: "Program de recomandări", enabled: true },
        { text: "4 Mesaje Automatizate", enabled: true },
        { text: "Asistent de cont personal", enabled: true },
        { text: "Acces manager personalizat", enabled: true },
        { text: "Notificări personalizate", enabled: true },
        { text: "Automatizări avansate", enabled: true },
        { text: "Integrare prin API", enabled: true },
