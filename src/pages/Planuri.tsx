...
const Planuri = () => {
  ...
  const plans = [
    {
      name: "START",
      description: "Pentru Întreprinderile mici care vor să devină mari mari în industria lor.",
      monthlyPrice: "149",
    ...
    },
    {
      ...
      monthlyPrice: "249",
      yearlyDiscount: "sau 2,490  RON / an. Primești 2 luni gratuite.",
      yearlyNote: "(plată unică)",
      features: [
        "1 Magazin",
        "500 Clienți"
    ...
    },
    {
      ...
      monthlyPrice: "399", 
      yearlyDiscount: "sau 3,990 RON / an. Primești 2 luni gratuite.",
      yearlyNote: "(plată unică)",
      features: [
        "1 Magazin",
        "Clienți nelimitați"
