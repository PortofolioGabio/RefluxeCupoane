  ...
  const plans = [
    {
      ...
      features: [
        ...
        { text: "Colectează Recenzii automat", enabled: false },
        { text: "Program pentru Happy-Hour", enabled: false },
        { text: "Formular de înscriere personalizat", enabled: false },
    ...
    },
    {
      ...
      features: [
        ...
        { text: "Media bonului și orele de activitate", enabled: true },
        { text: "Află cine revine și cât de des", enabled: true },
        { text: "Colectează Recenzii automat", enabled: true },
        { text: "Program pentru Happy-Hour", enabled: true },
        { text: "Formular de înscriere personalizat", enabled: true },
    ...
    },
    {
      ...
      features: [     
        ...
        { text: "Mesaje personalizate", enabled: true },
