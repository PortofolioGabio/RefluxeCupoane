  ...
  const plans = [
    {
      ...
      features: [
        { text: "10 promoții active în paralel", enabled: true },
        { text: "Până la 50 utilizatori manager", enabled: true },
        { text: "Clienți nelimitați în platformă", enabled: true },
        { text: "Notificări PUSH fără limită", enabled: true },
        { text: "Campanii speciale nelimitate", enabled: true },
        { text: "Mesaj automat când clientul se apropie", enabled: true },
        { text: "Valoarea medie a bonului + ore de vârf", enabled: true },
        { text: "Află cine revine și cât de des", enabled: true },
        { text: "Recenzii colectate automat", enabled: false },
        { text: "Happy Hour configurabil", enabled: false },
        { text: "Formulare complet personalizabile", enabled: false },
        { text: "Program de recomandări activ", enabled: false },
        { text: "4 automatizări predefinite", enabled: false },
        { text: "Manager personal de cont", enabled: false },
        { text: "Mesaje personalizate pentru clienți", enabled: false },
        { text: "Integrare API rapidă", enabled: false },
        { text: "Acces manager dedicat", enabled: false },
        { text: "Onboarding + configurare gratuită", enabled: false }
      ]
    },
    {
      name: "Boost",
      ...
      features: [
        ...
        { text: "Valoarea medie a bonului + ore de vârf", enabled: true },
        { text: "Află cine revine și cât de des", enabled: true },
        { text: "Recenzii colectate automat", enabled: true },
        { text: "Happy Hour configurabil", enabled: true },
        { text: "Formulare complet personalizabile", enabled: true },
        { text: "Program de recomandări activ", enabled: true },
        { text: "4 automatizări predefinite", enabled: true },
        { text: "Manager personal de cont", enabled: false },
        { text: "Mesaje personalizate pentru clienți", enabled: false },
        { text: "Integrare API rapidă", enabled: false },
        { text: "Acces manager dedicat", enabled: false },
    ...
    },
    {
      ...
      features: [
        ...
        { text: "Program de recomandări activ", enabled: true },
        { text: "4 automatizări predefinite", enabled: true },
        { text: "Manager personal de cont", enabled: true },
        { text: "Mesaje personalizate pentru clienți", enabled: true },
        { text: "Integrare API rapidă", enabled: true },
        { text: "Acces manager dedicat", enabled: true },
        { text: "Onboarding + configurare gratuită", enabled: true }
      ]
    }
  ];
